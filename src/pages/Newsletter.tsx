        ...
        >
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="max-w-md mx-auto">
                ...
                render={({ field }) => (
                  <FormItem className="flex items-center space-x-2 mb-6">
                    ...
                    <FormLabel htmlFor="privacy-policy" className="text-sm ">
                      I agree to the <a href="#" className="underline hover:text-[#ff6900]">Privacy Policy</a>
                    </FormLabel>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <Button 
                type="submit" 
                className="w-full bg-[#ff6900]  text-white py-6 uppercase tracking-wider hover:bg-[#ff6f00] transition duration-300 rounded-sm"
              >
                Subscribe
              </Button>
            </form>
